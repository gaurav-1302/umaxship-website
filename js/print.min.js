(function (a) {
  ...
  function g(f, b) {
    ...
    return (
      g === 0 &&
        (d = a('<iframe height="0" width="0" border="0" wmode="Opaque"/>')
          .prependTo("body")
      ...
      e(h, f, b)
        ...
        .fail(function (a) {
          console.error("Failed to print from iframe", a), c(f, b);
        })
        .always(function () {
          try {
            b.deferred.resolve();
  ...
  a.print = a.fn.print = function () {
    var e,
      ...
      m;
    if (
      (j instanceof a && (j = j.get(0)),
      f(j)
        ? ((i = a(j)), arguments.length > 0 && (e = arguments[0]))
        : arguments.length > 0
        ? ((i = a(arguments[0])),
          f(i[0])
            ? arguments.length > 1 && (e = arguments[1])
            : ((e = arguments[0]), (i = a("html"))))
        : (i = a("html")),
      (o = {
        globalStyles: !0,
        mediaPrint: !1,
      ...
      (k = a("")),
      e.globalStyles
        ? (k = a("style, link, meta, base, title"))
        : e.mediaPrint && (k = a("link[media=print]")),
      e.stylesheet)
    ) {
      (a.isArray ? a.isArray : Array.isArray)(e.stylesheet) ||
        (e.stylesheet = [e.stylesheet]);
      for (n = 0; n < e.stylesheet.length; n++)
        k = a.merge(
          k,
          a('<link rel="stylesheet" href="' + e.stylesheet[n] + '">')
        );
    }
    (h = b(i, !0, !0)),
      (h = a("<span/>").append(h)),
      ...
      e.title &&
        ((l = a("title", h)),
        l.length === 0 && ((l = a("<title />")), h.append(l)),
        l.text(e.title)),
      h.append(d(e.append)),
      h.prepend(d(e.prepend)),
      e.manuallyCopyFormValues &&
        (h.find("input").each(function () {
          var b = a(this);
          b.is("[type='radio']") || b.is("[type='checkbox']")
            ? b.prop("checked") && b.attr("checked", "checked")
            : b.attr("value", b.val());
        }),
