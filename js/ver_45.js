(function ($) {
  ...
  var pxl_swiper_handler = function ($scope, $) {
    ...
    /* Arrow Custom */
    $(".pxl-swiper-arrow-custom")
      .parents(".pxl-swiper-sliders")
      .addClass("pxl--hide-arrow");
    $(".pxl-navigation-carousel")
      .parents(".elementor-section")
      .addClass("pxl--hide-arrow");
    setTimeout(function () {
      $(".pxl-swiper-arrow-custom.pxl-swiper-arrow-next").on(
        "click",
        function () {
          $(this)
            .parents(".pxl-swiper-sliders")
            .find(".pxl-swiper-arrow-main.pxl-swiper-arrow-next")
            .trigger("click");
        }
      );
      $(".pxl-swiper-arrow-custom.pxl-swiper-arrow-prev").on(
        "click",
        function () {
          $(this)
            .parents(".pxl-swiper-sliders")
            .find(".pxl-swiper-arrow-main.pxl-swiper-arrow-prev")
            .trigger("click");
        }
      );
    }, 300);
      ...
      carousel_settings = {
        ...
        on: {
          ...
          slideChangeTransitionStart: function (swiper) {
            ...
            $scope
              .find(".pxl-element-slider .pxl-swiper-slide .wow")
              .each(function () {
      ...
      $scope.find(".swiper-filter-wrap .filter-item").on("click", function () {
        ...
        if (target == "all") {
          parent
            ...
            .addClass("swiper-slide-filter");
          swiper.destroy();
          swiper = new Swiper(carousel, carousel_settings);
        } else {
          parent
            .find(".swiper-slide-filter")
            .not(
              "[data-filter^='" +
                target +
                "'], [data-filter*=' " +
            ...
            .removeClass("swiper-slide-filter");
          parent
            .find(
              "[data-filter^='" +
                target +
  ...
  $(window).on("elementor/frontend/init", function () {
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/pxl_history_carousel.default",
      pxl_swiper_handler
    );
    elementorFrontend.hooks.addAction(
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/pxl_gallery_carousel.default",
      pxl_swiper_handler
    );
    elementorFrontend.hooks.addAction(
