(function () {
  ...
  RIBBON_HTML =
    '<span class="pxl-counterslide-ribbon"><span class="pxl-counterslide-ribbon-inner">' +
    VALUE_HTML +
    "</span></span>";

  DIGIT_HTML =
    '<span class="pxl-counterslide-digit"><span class="pxl-counterslide-digit-spacer">8</span><span class="pxl-counterslide-digit-inner">' +
    RIBBON_HTML +
    "</span></span>";
  ...
  Odometer = (function () {
    ...
    Odometer.prototype.update = function (newValue) {
      ...
      removeClass(
        this.el,
        "pxl-counterslide-animating-up pxl-counterslide-animating-down pxl-counterslide-animating"
      );
      if (diff > 0) {
  ...
  Odometer.init = function () {
    ...
    elements = document.querySelectorAll(
      Odometer.options.selector || ".pxl-counterslide"
    );
    _results = [];
