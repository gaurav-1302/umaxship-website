(() => {
  ...
  var d = {
      d: (c, b) => {
        for (var a in b)
          d.o(b, a) &&
            !d.o(c, a) &&
            Object.defineProperty(c, a, { enumerable: !0, get: b[a] });
      },
    ...
    h;
  function c(a) {
    if (((this.formData = {}), (this.tree = {}), !(a instanceof FormData)))
      return this;
    this.formData = a;
    const b = () => {
      const a = new Map();
    ...
    for (const [e, d] of this.formData) {
      ...
      if (a)
        if ("" === a.groups.array) this.tree.set(a.groups.name, d);
          ...
          const c = [
            ...a.groups.array.matchAll(/\[([a-z][-a-z0-9_:]*|[0-9]*)\]/gi),
          ].map(([b, a]) => a);
          c.unshift(a.groups.name);
          const e = c.pop();
          c.reduce((c, a) => {
            if (
              (/^[0-9]+$/.test(a) && (a = parseInt(a)), c.get(a) instanceof Map)
            )
              return c.get(a);
            const d = b();
            return c.set(a, d), d;
  ...
  d.r(b),
    ...
    (c.prototype.getAll = function (a) {
      ...
      const b = (a) => {
        const c = [];
        if (a instanceof Map) for (const [e, d] of a) c.push(...b(d));
        else "" !== a && c.push(a);
        return c;
      };
      return b(this.get(a));
  ...
  const B = function (b) {
          ...
          try {
            return ((a) =>
              ...
              [
                ...
                "webcal",
                "urn",
              ].indexOf(a))(new URL(a).protocol.replace(/:$/, ""));
          } catch {
            return !1;
          }
        })
    ...
    l = function (b) {
      if (
        !b.getAll(this.field).every((a) => {
          if (((a = a.trim()), !/^[0-9]{4,}-[0-9]{2}-[0-9]{2}$/.test(a)))
            return !1;
          const b = new Date(a);
    ...
    o = function (b) {
      if (
        !b
          .getAll(this.field)
          .every((a) => this.accept?.some((b) => a === String(b)))
      )
        throw new a(this);
    },
    p = function (b) {
      if (
        !b.getAll(this.field).every((b) => {
    ...
    u = function (b) {
      if (
        !b
          .getAll(this.field)
          .every((a) => !(parseFloat(a) < parseFloat(this.threshold)))
      )
        throw new a(this);
    },
    v = function (b) {
      if (
        !b
          .getAll(this.field)
          .every((a) => !(parseFloat(this.threshold) < parseFloat(a)))
      )
        throw new a(this);
    },
    w = function (b) {
    ...
    g = ({ ruleObj: c, options: d }) => {
      const { rule: a, ...e } = c;
      return (
        "function" == typeof b[a] &&
        ("function" != typeof b[a].matches || b[a].matches(e, d))
      );
    },
    ...
    E = function (c, b = {}) {
      ...
      if (
        !d.every((d) => {
          try {
            h({ ruleObj: d, formDataTree: c, options: b });
          } catch (b) {
  ...
  window.swv = {
    ...
    validate: (k, i, d = {}) => {
      ...
      const j = e(f),
        ...
        b = h.reduce((b, e) => {
          try {
            j({ ruleObj: e, formDataTree: c, options: d });
          } catch (c) {
            if (!(c instanceof a)) throw c;
            if (void 0 !== c.field && !b.has(c.field) && void 0 !== c.error)
              return b.set(c.field, c);
          }
          return b;
        }, new Map());
      for (const a of c.keys())
        b.has(a) || b.set(a, { validInputs: c.getAll(a) });
      return b;
    },
    use: (a) => {
      i.push(a);
